  ...
  (color-theme-install
   '(color-theme-github
     ((background-color . "#f7f7ff")
      ...
      (mouse-color . "#bcd5fa"))
     ()
     (default ((t (:stipple nil :background "#f7f7ff" :foreground "#000000" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal))))
     ...
     (mode-line ((t (:background "#f7f7ff" :foreground "#888888" :box (:line-width 0 :style released-button) :height 1.1))))
