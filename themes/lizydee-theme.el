...
(defun color-theme-lizydee ()
  "I have no idea where this theme came from but I'm using it now.
With Love, cheapRoc."
  (interactive)
  (color-theme-install
   '(color-theme-lizydee
...
;;  'lizylee
;;  '(default ((t (:background "black" :foreground "#e2e2e5"))))
;;  '(font-lock-builtin-face ((t (:foreground "#808080"))))
;;  '(region ((t (:background "#303030" :foreground "#afafff"))))
;;  '(highlight ((t (:background "#303030"))))
;;  '(fringe ((t (:background "#232323" :foreground "#cfbfad"))))
