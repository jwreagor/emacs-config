...
(custom-set-variables
 ...
 '(package-selected-packages
   '(eglot project xref go-eldoc go-autocomplete cl-lib helm-lsp go-playground virtualenvwrapper elpy sqlup-mode company-go popup-complete auto-complete exec-path-from-shell go-errcheck go-imports go-scratch racer cargo rust-playground go-stacktracer markdown-mode protobuf-mode terraform-mode systemd yard-mode yaml-mode ws-trim toml-mode toml rustfmt ruby-electric ruby-compilation restclient-helm rainbow-mode projectile-direnv paredit osx-location osx-browse org-projectile nix-mode nginx-mode minitest httprepl helm-projectile helm-proc helm-package helm-descbinds helm-ag handlebars-mode haml-mode es-mode eredis erc-terminal-notifier erc-hl-nicks enh-ruby-mode elixir-mode elixir-mix editorconfig dockerfile-mode company-racer color-theme-solarized color-theme-monokai color-theme-molokai cider chruby arduino-mode ag ack-and-a-half))
